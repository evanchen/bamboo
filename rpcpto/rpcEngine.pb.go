...
type RpcEngineClient interface {
	RegisterGame(ctx context.Context, in *ReqRegister, opts ...grpc.CallOption) (*RetRegister, error)
}
...
func (c *rpcEngineClient) RegisterGame(ctx context.Context, in *ReqRegister, opts ...grpc.CallOption) (*RetRegister, error) {
	out := new(RetRegister)
	err := grpc.Invoke(ctx, "/rpcpto.RpcEngine/RegisterGame", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RpcEngineServer interface {
	RegisterGame(context.Context, *ReqRegister) (*RetRegister, error)
}
...
func _RpcEngine_RegisterGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqRegister)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RpcEngineServer).RegisterGame(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcpto.RpcEngine/RegisterGame",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RpcEngineServer).RegisterGame(ctx, req.(*ReqRegister))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RpcEngine_RegisterGame_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0xa0, 0x2a, 0x40, 0x4c, 0x23, 0x77, 0x2e, 0xce, 0x20, 0x98, 0xf1, 0x42, 0x56, 0x5c, 0x3c, 0x30,
	0xa5, 0xee, 0x89, 0xb9, 0xa9, 0x42, 0xc2, 0x7a, 0x10, 0x9b, 0xf4, 0x90, 0xac, 0x91, 0x42, 0x12,
	0x84, 0x1b, 0xac, 0xc4, 0x90, 0xc4, 0x06, 0x76, 0x9b, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x7a,
	0xc3, 0x8c, 0xf1, 0xae, 0x00, 0x00, 0x00,
}
